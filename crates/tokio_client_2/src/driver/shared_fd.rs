...
enum State {
    #[cfg(all(any(target_os = "linux", target_os = "android"), feature = "iouring"))]
    Uring(UringState),
    #[cfg(feature = "legacy")]
    Legacy(Option<usize>),
}
...
impl State {
    ...
    #[cfg(not(all(any(target_os = "linux", target_os = "android"), feature = "iouring")))]
    #[inline]
...
impl SharedFd {
    ...
    pub(crate) fn new<const FORCE_LEGACY: bool>(fd: RawFd) -> io::Result<SharedFd> {
        ...
        #[cfg(all(any(target_os = "linux", target_os = "android"), feature = "iouring", feature = "legacy"))]
        ...
        #[cfg(all(not(feature = "legacy"), any(target_os = "linux", target_os = "android"), feature = "iouring"))]
        let state = State::Uring(UringState::Init);

        #[cfg(all(
            unix,
            feature = "legacy",
            not(all(any(target_os = "linux", target_os = "android"), feature = "iouring"))
        ))]
        let state = {
    ...
    pub(crate) fn registered_index(&self) -> Option<usize> {
        ...
        match state {
            #[cfg(all(any(target_os = "linux", target_os = "android"), feature = "iouring", feature = "poll-io"))]
...
fn drop_legacy(mut fd: RawFd, idx: Option<usize>) {
    if CURRENT.is_set() {
        CURRENT.with(|inner| {
            #[cfg(any(all(any(target_os = "linux", target_os = "android"), feature = "iouring"), feature = "legacy"))]
            match inner {
                #[cfg(all(any(target_os = "linux", target_os = "android"), feature = "iouring"))]
                super::Inner::Uring(_) => {
