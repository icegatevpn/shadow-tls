...
crate::scoped_thread_local!(pub(crate) static CURRENT: Inner);
...
impl Inner {
    ...
    #[cfg(all(any(target_os = "linux", target_os = "android"), feature = "iouring", not(feature = "legacy")))]
    fn is_legacy(&self) -> bool {
        false
    }
...
#[cfg(all(feature = "sync", any(target_os = "linux", target_os = "android"), feature = "iouring"))]
